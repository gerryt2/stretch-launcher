package com.stretchsense.demosingle;

import com.stretchsense.demosingle.ble.StretchSenseLibraryManager;
import com.stretchsense.demosingle.ble.StretchSensePeripheralAvailable;
import com.stretchsense.demosingle.ble.StretchSensePeripheralConnected;
...
public class MainActivity extends AppCompatActivity implements StretchSenseLibraryManager.StretchSenseLibraryManagerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Element of the UI
        textFeedback = (TextView)findViewById(R.id.textViewFeedbackSensor);
        textAddress = (TextView)findViewById(R.id.textViewAddress);
        textValue = (TextView)findViewById(R.id.textViewValueOfTheSensor);
    ...
    public void onPeripheralDiscovered(String deviceNameToScanFor, BluetoothDevice device, int rssi, byte[] scanRecord) {
        ...
        changeTheTextOf(textInformation, "A StretchSense sensor has been detected");
    ...
    public void onDisconnected() {
        ...
        // Loading information for the user
        changeTheTextOf(textInformation, "A StretchSense sensor has been disconected");
        // Loading feedback information
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        // Loading information for the user
        changeTheTextOf(textInformation, "A StretchSense sensor is updating");
        // Loading feedback information
